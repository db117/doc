---
title: 个人净资产追踪使用指南
description: 使用个人净资产追踪工具维护资产、负债、外币汇率和分期项目，并通过本地、OneDrive 或 Google Drive 备份与恢复账本。
---
...
| 云端覆盖后想恢复原数据      | 在“备份”页点击“恢复回退账本”；系统只保留最近一次覆盖前的版本。              |
| 清除浏览器数据后账本丢失    | 本地数据无法由站点恢复，请上传之前下载的 JSON，或从已连接的云端恢复副本。   |
