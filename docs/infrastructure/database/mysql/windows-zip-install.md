---
title: MySQL Windows 解压安装
---

# MySQL Windows 解压安装（5.7，8.0）
...
* 创建my.ini文件，内容如下：
   ...
   ```
    *
    注意，basedir和datadir是必须要配置的，basedir就是你解压的目录。官方文档上说，如果你喜欢用反斜杠，则要用双反斜杠，斜杠的话就不用这样。即：D:
    \\mysql-5.7.13-winx64\\ 或：D:/mysql-5.7.13-winx64/
