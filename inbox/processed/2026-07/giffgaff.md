...
- GiffGaff
    - 官方APP
    - https://mi9.com/package/com.giffgaffmobile.controller/
...
### 安装GiffGaff/Via浏览器/HookEuicc

在元萝卜-》配置-〉从管理器安装软体-》选择apk
...
直接不选择套餐然后就充值10欧元就能开通

### 安装esim

- 选择 install esim，提示一串字符串
- 复制到esim卡管理工具中进行添加即可
